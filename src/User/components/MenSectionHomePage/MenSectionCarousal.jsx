...
const MenCarousal = () => {
  ...
  const validMenData = MenData.filter(item => item && item.id && item.image);
  ...
  const actualItemsCount = validMenData.length;
    ...
    <section className="py-8 sm:py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        {/* <div className="flex justify-center mt-6">
          {validMenData.slice(0, Math.ceil(actualItemsCount / itemsPerView)).map((_, index) => (
            <button
              key={index}
