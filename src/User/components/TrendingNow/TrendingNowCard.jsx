    ...
    >
      <div className="bg-white rounded-none overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col">
        ...
        <div className="p-3 sm:p-4 text-center flex-shrink-0">
          <h3 className="text-xs sm:text-sm font-bold text-gray-900 uppercase tracking-tight mb-1 group-hover:text-red-600 transition-colors duration-200 line-clamp-2">
            {category.name}
          </h3>
          <p className="text-xs sm:text-xs text-gray-700 font-medium">
