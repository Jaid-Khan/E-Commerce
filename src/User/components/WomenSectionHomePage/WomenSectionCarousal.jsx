...
const WomenCarousel = () => {
  ...
  const actualItemsCount = WomenData.length;
    ...
    <section className="py-8 sm:py-12 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-xs sm:text-sm text-red-600 font-semibold text-center mb-6 sm:mb-10 tracking-wide">
          {/* WOMEN'S COLLECTION  */}
          <span className="text-xl sm:text-2xl md:text-3xl text-black block mt-1 sm:mt-2 font-bold">Discover the Women’s Collection</span>
        </h2>
